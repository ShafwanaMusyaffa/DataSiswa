...
<head>
  ...
  <title>Daftar &mdash; DASIS</title>
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <form method="POST" action="{{ route('register.custom') }}" class="needs-validation" novalidate="">
                  @csrf
            ...
            <div class="mt-5 text-muted text-center">
              Sudah punya akun? <a href="/login">Create One</a>
            </div>
            <div class="simple-footer">
              Copyright &copy; DASIS 2022
            </div>
          </div>
        </div>
      </div>
